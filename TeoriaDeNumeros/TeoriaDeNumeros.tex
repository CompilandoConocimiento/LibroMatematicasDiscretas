...
\chapter{Congruencias}
            ...
            \begin{itemize}
                ...
                \item Si $GCD(c, n) = 1$ y $ac \equiv bc \pmod{n}$ entonces $a \equiv b \pmod{n}$
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        propiedad que demostramos (supoón $GCD(a, b) = 1$ y que $a|bc$, entonces $a|c$)
    ...
    % =====================================================
    \clearpage
    \section{Encontrar si $n$ es divisible entre $m$ usando Congruencias}
    ...
    % =====================================================
    \clearpage
    \section{Aritmética Modular: Clases $\Integers_n$ y $[a]_n$}
        ...
        \subsection*{Definición Formal}
            ...
            Podemos ser aburridos y serios y hacer dos definiciones formales
            para sacarlas del camino y decir que:

            \subsubsection*{Clase Congruencias Modulo N}

                Una Clase Congruencia Modulo N (k) es un conjunto que cumple con:

                \begin{equation}
                    [k]_n = \{ x \in \Integers \Such x \equiv a \pmod{n} \}
                \end{equation}
            ...
            \subsubsection*{Conjunto de Congruencias Modulo N: $\Integers_n$}
