...
\chapter{Teoría de Congruencias}
    ...
    Gauss introdujo en concepto de congruencias en su famoso libro de Disquisisiones
    Aritméticas.
    ...
    \section{Congruencia Módulo N}
        ...
        \subsection*{Definición Formal}
            ...
            La idea principal de este nombre se da por esta propiedad:

            Dos enteros arbitrarios $a,b \in \Integers$ son congruentes módulo $n$,
            esto es $a \equiv b \pmod{n}$, si y sólo si $a$ y $b$ dejan el mismo
            residuo positivo al ser divididos por $n$.

            % ======== DEMOSTRACION ========
            \begin{SmallIndentation}[1em]
                \textbf{Demostración}:

                Si aplicamos el algoritmo de la división tenemos primero que $a=nq_1+r_1$
                y $b=nq_2+r_2$ ademas sabemos que $a \equiv b \pmod{n}$, por lo tanto
                $n|a-b$ es decir $a-b=kn$.
        ...
        \subsection*{Propiedades}
            ...
            \begin{itemize}
                ...
                \item Cualesquiera dos enteros son congruentes módulo 1

                    % ======== DEMOSTRACION ========
                    \begin{SmallIndentation}[1em]
                        \textbf{Demostración}:

                        Esto es muy obvio, pues si $a \equiv b \pmod{1}$ entonces
                        entonces $1|a-b$ y sabemos por propiedades de divisibilidad
                        esta proposición siempre es verdadera.

                    \end{SmallIndentation}

                \item Si $a=bq+r$ entonces $a \equiv r \pmod{b}$, es decir, todo
                    entero es congruente a su residuo $r$ al ser dividido por $b$
                    (módulo $b$).
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        Sabemos que $b|bq$, que es lo mismo que decir $b|bq+r-r$,
                        que es lo mismo que $b|(bq+r)-r$, osea $b|a-r$. 
